...
form.addEventListener("submit", function (event) {
    ...
    if (generatedResume) {
        ...
        var shareableURL = "".concat(window.location.origin, "?user#na?me=").concat(encodeURIComponent(username));
        var generatedLink = document.querySelector(".generated-link");
        var shareableLink = document.querySelector(".Shareable-link");
